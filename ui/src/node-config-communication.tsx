						...
						{directoryPending ? (
							...
							visibleMemberOptions.map((user) => (
								...
								>
									...
									<span
										aria-hidden="true"
										className="flex size-5 shrink-0 items-center justify-center rounded-full bg-primary/15 font-medium text-[10px] text-primary"
									>
